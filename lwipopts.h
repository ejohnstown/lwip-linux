...
#define LWIP_COMPAT_MUTEX               0 /* posix */
#define LWIP_COMPAT_MUTEX_ALLOWED       0 /* posix */
#define LWIP_COMPAT_THREADING           1 /* posix */
#define LWIP_POSIX_SOCKETS_IO_NAMES     1
#define LWIP_POSIX_SOCKETS_IO_NAMES_NONSTD 1
#define LWIP_UNIX_MMAN                  1
